  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: NavigationBar(
        destinations: [
          NavigationDestination(selectedIcon: Icon(MdiIcons.calendarWeek), icon: Icon(MdiIcons.calendarWeek), label: 'Ver Actividades'),
          NavigationDestination(selectedIcon: Icon(MdiIcons.calendar), icon: Icon(MdiIcons.calendar), label: 'Calendario'),
        ],
